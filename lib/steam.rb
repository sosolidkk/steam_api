...
require 'steam/requestors/player_friends'
require 'steam/requestors/player_game_stats'
require 'steam/requestors/player_level'
require 'steam/requestors/player_owned_games'
...
require 'steam/structs/player_friends'
require 'steam/structs/player_game_stats'
require 'steam/structs/player_level'
require 'steam/structs/player_owned_games'
...
require 'steam/structs/requests/get_player_friends'
require 'steam/structs/requests/get_player_game_stats'
require 'steam/structs/requests/get_player_level'
require 'steam/structs/requests/get_player_owned_games'
